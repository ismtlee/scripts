...
#logfile=/usr/deploy/jmmq/logs/log2_${lastday}_01
output=$root/output/country_by_en_$lastday
rm -rf $output
pig -x local -param out_dir=$output -param logfile=$logfile $root/country_by_en.pig 
