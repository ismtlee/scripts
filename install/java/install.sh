...
#64 bit
wget http://download.oracle.com/otn-pub/java/jdk/7u17-b02/$pkgname --no-check-certificate --no-cookies --header "Cookie: gpw_e24=http%3A%2F%2Fwww.oracle.com"
mkdir /usr/java -O $pkgname
rpm -ivh $pkgname  
