...
#排重
v0=`grep -v 218.104.71.178 $LOG_PATH/promote_static_$LASTDAY.log|grep "click_window&t=0"|grep -oE "imei=(\w|-)*"|sort -u|wc -l`
v10=`grep -v 218.104.71.178 $LOG_PATH/promote_static_$LASTDAY.log|grep "click_window&t=10"|grep -oE "imei=(\w|-)*"|sort -u|wc -l`
v60=`grep -v 218.104.71.178 $LOG_PATH/promote_static_$LASTDAY.log|grep "click_window&t=60"|grep -oE "imei=(\w|-)*"|sort -u|wc -l`
v110=`grep -v 218.104.71.178 $LOG_PATH/promote_static_$LASTDAY.log|grep "click_window&t=110"|grep -oE "imei=(\w|-)*"|sort -u|wc -l`
v300=`grep -v 218.104.71.178 $LOG_PATH/promote_static_$LASTDAY.log|grep "click_window&t=300"|grep -oE "imei=(\w|-)*"|sort -u|wc -l`
vobtain=`grep -v 218.104.71.178 $LOG_PATH/promote_static_$LASTDAY.log|grep "click_obtain"|grep -oE "imei=(\w|-)*"|sort -u|wc -l`
vmore=`grep -v 218.104.71.178 $LOG_PATH/promote_static_$LASTDAY.log|grep "click_more"|grep -oE "imei=(\w|-)*"|sort -u|wc -l`
